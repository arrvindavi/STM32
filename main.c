...
//UART1 Interrupt Variables
#define RX_BUFFER_SIZE 64
uint8_t rx_buffer[RX_BUFFER_SIZE];
uint8_t rx_data;
uint8_t rx_index = 0;
int value[5];  // To store 5 parsed integers
uint8_t tx_buffer[64];  // For UART4 transmission

volatile uint8_t uart4TxReady = 1;
//Transmit Variables
char printMessage[100];
uint16_t prevCount = 0xFFFF;
char uartMsg[50];
...
// Transmit to Uart 4
		...
		HAL_UART_Receive_IT(&huart1, &rx_data, 1);  // Continue reception
	}
}
